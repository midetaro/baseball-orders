...
class MiddleDistanceBattingBehaviorTest {
    ...
    static Stream<Arguments> battingTestCases() {
        return Stream.of(
                ...
                arguments("二塁打配分なら二塁打になる", 0.34f, BattingResult.HIT_DOUBLE),
                arguments("三塁打配分なら三塁打になる", 0.36f, BattingResult.HIT_TRIPLE),
                arguments("本塁打配分なら本塁打になる", 0.39f, BattingResult.HIT_HOMER),
