...
public final class BatterTestDataFactory {
    ...
    public static List<BatterEntity> mock() {
        return List.of(
                new BatterEntity("batter1", 0.4f, 0.4f, shortDistanceAtBatBehavior, aggressiveStealBehavior),
                new BatterEntity("batter2", 0.4f, 0.2f, shortDistanceAtBatBehavior, aggressiveStealBehavior),
                new BatterEntity("batter3", 0.25f, 0.5f, shortDistanceAtBatBehavior, middleStealBehavior),
                new BatterEntity("batter1", 0.2f, 0.7f, shortDistanceAtBatBehavior, nowayStealBehavior),
                new BatterEntity("batter2", 0.4f, 0.5f, shortDistanceAtBatBehavior, middleStealBehavior),
                new BatterEntity("batter3", 0.3f, 0.3f, shortDistanceAtBatBehavior, middleStealBehavior),
                new BatterEntity("batter1", 0.3f, 0.6f, shortDistanceAtBatBehavior, middleStealBehavior),
                new BatterEntity("batter2", 0.3f, 0.4f, shortDistanceAtBatBehavior, middleStealBehavior),
                new BatterEntity("batter3", 0.3f, 0.5f, shortDistanceAtBatBehavior, middleStealBehavior)
        );
    }
}
