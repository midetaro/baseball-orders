...
public abstract class BasesState {
    ...
    public final BasesState advance(Base bases) {
        return switch (bases) {
    ...
    public final BasesState withRunnerAt(Base base, BatterEntity runner) {
        return switch (base) {
    ...
    /** アウトとなった打撃結果を適用する。 */
    public void out(GameBattingContext context) {
